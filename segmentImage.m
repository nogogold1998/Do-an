%segmentImage performs patchwise semantic segmentation on the input image
% using the provided network.
%
%  OUT = segmentImage(IM, NET, PATCHSIZE) returns a semantically 
...
function out = segmentImage(im, net, patchSize)
